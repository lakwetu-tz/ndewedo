    ...
    <div className="w-full bg-white">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-[1000px]">
          <span className="font-['Poppins'] text-[13px] tracking-[6px] text-white/80 uppercase block mb-6 animate-fadeIn">Premier Expedition</span>
      ...
      <section className="py-24 px-6 bg-[#fdfcfb]">
        <div className="max-w-[1000px] mx-auto text-center">
          <span className="font-['Poppins'] text-[13px] tracking-[4px] text-[#c97500] uppercase block mb-8">THE EXPERIENCE</span>
          <h2 className="font-serif text-[32px] md:text-[48px] text-[#222] leading-tight mb-12">
            A meticulously crafted journey through <span className="italic">Tanzania's most celebrated landscapes.</span>
          </h2>
            ...
            <div className="lg:col-span-8 space-y-24">
              ...
              <div id="overview" className="space-y-12">
                <div className="flex justify-between items-end">
                  <h3 className="font-serif text-[32px] text-[#222]">Visual Journey</h3>
                  <span className="font-['Poppins'] text-[12px] tracking-[2px] text-[#888] uppercase">6 Captures</span>
                </div>
                <div className="grid grid-cols-12 gap-4">
                  ...
                  <div className="col-span-4 relative aspect-[1/1.2] overflow-hidden rounded-[2px]">
                    <ImageWithFallback src={packageGallery[2]} alt="Safari" className="object-cover hover:scale-105 transition-transform duration-700" />
                  </div>
                  <div className="col-span-4 relative aspect-[1/1.2] overflow-hidden rounded-[2px]">
                    <ImageWithFallback src={packageGallery[3]} alt="Safari" className="object-cover hover:scale-105 transition-transform duration-700" />
                  </div>
                  <div className="col-span-8 relative aspect-[16/10] overflow-hidden rounded-[2px]">
                    <ImageWithFallback src={packageGallery[4]} alt="Safari" className="object-cover hover:scale-105 transition-transform duration-700" />
                  </div>
                </div>
              </div>
              ...
              <div id="itinerary" className="space-y-12">
                <div className="border-b border-gray-100 pb-8">
                  <h3 className="font-serif text-[40px] text-[#222]">Day-by-Day <span className="text-[#1f751f]">Itinerary</span></h3>
                </div>
