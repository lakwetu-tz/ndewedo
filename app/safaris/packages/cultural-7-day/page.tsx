...
export default function CulturalSafariJapanPage() {
  ...
  const duration = "7 Days / 6 Nights";
  const rating = 5.0;
  const reviewCount = 68;

  const highlights = [
    { icon: Compass, label: 'Culture', value: 'Maasai' },
    { icon: Mountain, label: 'Parks', value: '4' },
    { icon: Palette, label: 'Experience', value: 'Cultural' },
      ...
      <section ref={heroRef} className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <Link href="/cultural-tours" className="text-white/60 hover:text-white transition-colors">Cultural</Link>
            <span className="text-white/30">/</span>
            <span className="text-[#c97500]">7-Day</span>
          </motion.div>
