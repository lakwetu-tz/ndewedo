...
export default function LuxuryCrossBorderPage() {
  ...
  const rating = 5.0;
  const reviewCount = 203;

  const highlights = [
    { icon: Compass, label: 'Countries', value: '2' },
    { icon: Mountain, label: 'Parks', value: '5' },
    { icon: Palette, label: 'Experience', value: 'Ultra-Luxury' },
      ...
      <section ref={heroRef} className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <Link href="/safaris/luxury" className="text-white/60 hover:text-white transition-colors">Luxury</Link>
            <span className="text-white/30">/</span>
            <span className="text-[#c97500]">Cross-Border</span>
          </motion.div>
        ...
        <div className="relative max-w-[1000px] mx-auto text-center">
          ...
          >
            ...
            <h2 className="font-serif text-[32px] md:text-[48px] text-white leading-tight mb-8">
              Crossing borders to witness <span className="italic text-[#c97500]">Africa's greatest wildlife theater.</span>
            </h2>
          </motion.div>
              ...
              <div id="rates" className="bg-[#f9f9f7] p-12 rounded-[2px]">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center py-6 border-b border-black/5">
                    <div>
                      <h4 className="font-['Poppins'] text-[14px] tracking-[2px] uppercase text-[#222]">Ultra-Luxury Collection</h4>
