...
const packageGallery = [
  ...
  'https://images.unsplash.com/photo-1589182397057-b1617b7109e5?auto=format&fit=crop&w=1080&q=80',
];

const itinerary = [
  {
    day: 1,
    title: 'Arrival in Nairobi – Kenya Welcome',
    location: 'Nairobi Boutique Lodge',
    activities: [
      ...
      'Rest and preparation for the journey'
    ],
    meals: 'Dinner included',
    accommodation: 'Nairobi Boutique Lodge',
  ...
  },
  {
    ...
    activities: [
      ...
      'Arrival and check-in at luxury reserve lodge',
      'Late afternoon game drive: big cats and plains game',
      'Sunset photography on the Mara'
    ],
    meals: 'Full board',
  ...
  {
    day: 8,
    title: 'Amboseli to Arusha – Border Crossing',
    location: 'Pazuri Inn',
    activities: [
      'Breakfast and drive to Namanga border',
      'Cross-border formalities with guide assistance',
      'Continue to Arusha – the safari capital of Tanzania',
      'Tanzania portion briefing and market walk'
    ],
  ...
  },
  {
    ...
    activities: [
      'Breakfast with sweeping sea views',
      'Final leisure time on the beach or by the pool',
      'Transfer to airport for your onward journey',
      'Cherished memories of East Africa'
    ],
    meals: 'Breakfast',
            ...
            <div className="lg:col-span-8 space-y-24">
              ...
              <div id="overview" className="space-y-12">
                <div className="flex justify-between items-end">
                  <h3 className="font-serif text-[32px] text-[#222]">Curation of Discovery</h3>
                  <span className="font-['Poppins'] text-[12px] tracking-[2px] text-[#888] uppercase">Signature Series</span>
                </div>
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-8 relative aspect-[16/10] overflow-hidden rounded-[2px]">
                    <ImageWithFallback src={packageGallery[1]} alt="Kenya" className="object-cover hover:scale-105 transition-transform duration-700" />
                  </div>
                  <div className="col-span-4 relative aspect-[1/1.2] overflow-hidden rounded-[2px]">
                    <ImageWithFallback src={packageGallery[5]} alt="Tanzania" className="object-cover hover:scale-105 transition-transform duration-700" />
                  </div>
                  <div className="col-span-12 relative aspect-[21/9] overflow-hidden rounded-[2px]">
                    <ImageWithFallback src={packageGallery[4]} alt="Zanzibar" className="object-cover hover:scale-105 transition-transform duration-700" />
                  </div>
                </div>
              </div>
              ...
              <div id="rates" className="bg-[#f9f9f7] p-12 rounded-[2px]">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center py-6 border-b border-black/5">
                    <div>
                      <h4 className="font-['Poppins'] text-[14px] tracking-[2px] uppercase text-[#222]">Full Journey</h4>
                      <p className="text-[14px] text-[#666]">Private Multi-Country Package</p>
                    </div>
                ...
                <div className="mt-8 flex items-start gap-3 text-[#888] text-[14px]">
                   ...
                   <p>Based on a group of 4 travelers. Includes balloon flight, cultural visits, and Zanzibar logistics.</p>
                </div>
              </div>
            </div>
              ...
              <div className="sticky top-32 space-y-12">
                ...
                <div className="bg-[#1a1a1a] text-white p-10 rounded-[2px] shadow-2xl">
                  <div className="mb-8 text-center">
                    ...
                    <p className="text-[14px] text-white/40 mt-2 italic">per person</p>
                  </div>
                ...
                <div id="inclusions" className="bg-[#fdfcfb] border border-gray-100 p-10 rounded-[2px]">
                  <h4 className="font-serif text-[24px] text-[#222] mb-8">Inclusive <span className="text-[#1f751f]">Excellence</span></h4>
                  <ul className="space-y-4">
                    {[
                      'Full Private 4x4 & Guide',
                      'Hot Air Balloon Safari',
                      'Maasai Cultural Exchange',
                      'Zanzibar Domestic Flight',
      ...
      <section className="py-24 px-6 bg-white border-t border-gray-100">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-[40px] text-[#222]">The <span className="italic text-[#1f751f]">Grand</span> Perspective</h2>
          </div>
          <div className="max-w-[800px] mx-auto text-center">
            ...
            <p className="font-quattro text-[24px] text-[#222] italic leading-relaxed mb-10">
              "Balloon over Serengeti, Maasai dances, and Zanzibar beaches — private guiding made it seamless and truly unforgettable. An epic journey!"
            </p>
            <div className="font-['Poppins'] text-[14px] tracking-[3px] uppercase text-[#222]">Maria K.</div>
            <div className="text-[12px] tracking-[1px] text-[#888] mt-2">Germany • Mar 2026</div>
          </div>
        </div>
      </section>
