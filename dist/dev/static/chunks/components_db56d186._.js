...
function Header({ transparent = false }) {
    ...
    const [safariDropdownOpen, setSafariDropdownOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
...
_s(Header, "rAp3gEIWUGqItv36bQebSRtr3Jk=", false, function() {
    return [
...
function Footer() {
    ...
    const handleSubscribe = async (e)=>{
        e.preventDefault();
        if (!email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Please enter your email');
            return;
        }
        ...
        try {
            ...
            if (data.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(data.message || 'Thank you for subscribing!');
                setEmail('');
                setName('');
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.message || 'Failed to subscribe');
            }
        } catch (error) {
...
_s(Footer, "2LOSTMHqAgpRv6oUGBClKHk9pvI=");
_c = Footer;
var _c;
...
"[project]/components/NewsletterPopup.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewsletterPopup() {
        ...
        "NewsletterPopup.useEffect": ()=>{
            ...
            if (!hasSeenPopup) {
                ...
                const timer = setTimeout({
                    "NewsletterPopup.useEffect.timer": ()=>{
                        setIsOpen(true);
                    }
                }["NewsletterPopup.useEffect.timer"], 5000);
                return ({
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            console.error('Newsletter error:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to connect to the server. Please try again later.');
        } finally{
            setIsSubmitting(false);
        }
    };
...
_s(NewsletterPopup, "2R+CgOlveug3u2x8inP/461BcpA=");
_c = NewsletterPopup;
var _c;
...
//# sourceMappingURL=components_db56d186._.js.map